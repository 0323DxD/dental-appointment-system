            ...
            <div id="content">
                ...
                <div class="container-fluid px-3">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body fs-5 fw-bold mb-0 d-flex justify-content-between align-items-center">
                            <p class="text-primary" style="margin-bottom: 0px;">Name:
                                <?php echo $row['name'] ?>
                            </p>
                            <button type="button" class="btn btn-book editnamebtn" data-bs-toggle="modal"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="forms needs-validation" method="POST"
                                    action="/dental-appointment-system/pages/patient/api/changeusername" novalidate="">
                ...
                <div class="modal fade" id="editNameModal" tabindex="-1" aria-labelledby="editNameModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editNameModalLabel"><i
                                        class="bi bi-person-fill-gear"></i> Change Name</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="forms needs-validation" method="POST"
                                    action="/dental-appointment-system/pages/patient/api/changename" novalidate="">
                                    <input type="hidden" name="update_id" value="<?php echo $row['id']; ?>">
                                    <div class="form-floating mb-3">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" name="updatename" class="btn btn-book"><i
                                        class="bi bi-person-fill-gear"></i> Change Name</button>
                            </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="editPasswordModal" tabindex="-1" aria-labelledby="editPasswordModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="forms needs-validation" method="POST"
                                    action="dental-appointment-system/pages/patient/api/changepassword" novalidate="">
