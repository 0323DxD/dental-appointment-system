...
<head>
    ...
    <title>Users - Trinity Smiles Dental</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid px-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary font-weight-bold">Users</h1>
                ...
                <div class="modal fade" id="deletemodal" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="/dental-appointment-system/pages/admin/api/deleteuser" method="post">
                ...
                <div class="modal fade" id="addServiceModal" tabindex="-1" aria-labelledby="addServiceModal"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addServiceModalLabel">Add New User</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <form action="/dental-appointment-system/pages/admin/api/createuser" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input id="email" type="email" name="email"
                                            ...
                                            placeholder="Email Address" value="" placeholder="Email Address" required />
                                        <label for="email">
                                            Email Address
                                        </label>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input id="username" type="text" name="username"
                                            ...
                                            onkeypress="return noSpace(event)"
                                            class="form-control form-control-md rounded-3 mt-2" value=""
                                    ...
                                    <div class="form-floating mb-3">
                                        <input id="password" type="password" name="password"
                                            onkeypress="return noSpace(event)"
                                            class="form-control form-control-md rounded-3 mt-2" placeholder="Password"
                                            required />
                                        <label for="password">
                                            Password
                                        </label>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-book">Add User</button>
                                </div>
                            </form>
                        </div>
                    </div>
