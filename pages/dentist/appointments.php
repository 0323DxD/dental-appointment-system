...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                        ...
                        <div class="data_table">
                            <table id="myTable" class="table table-bordered" style="width:100%">
                                ...
                                <tbody class="text-dark">
                                    <?php
                                    $assigned_doctor = $_SESSION['name'];
                                    $query = "SELECT * FROM appointments WHERE assigned_doctor='$assigned_doctor'";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group me-2">
                                                        ...
                                                        <button type="button" class="btn btn-success btn-md editdatebtn px-2"><i
                ...
                <div class="modal fade" id="editmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="/dental-appointment-system/pages/dentist/api/updateschedule" method="post"
                ...
                <div class="modal fade" id="deletemodal" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="/dental-appointment-system/pages/dentist/api/deleteappointment" method="post">
                                <div class="modal-body">
                ...
                <div class="modal fade" id="editdatemodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    aria-labelledby="editDateModal" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editDateModal">
                                    <i class="bi bi-pencil-square"></i>
                                    Update Appointment
                                </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                            ...
                            ?>
                            <form action="/dental-appointment-system/pages/dentist/api/editappointment" method="post"
                                class="needs-validation" novalidate>
                                <div class="modal-body">
                                    <input type="hidden" name="update_id" id="updatedate_id">
                                    <div class="form-floating mb-3">
                                        <input id="updatebookingDate" type="date" name="bookingDate"
                                    ...
                                    <div class="form-floating">
                                        <input id="updatepreferredTime" type="time" name="preferredTime"
        ...
        <?php
        $assigned_doctor = $_SESSION['name'];
        $query = "SELECT name as title, CONCAT(bookingDate, 'T', preferredTime) as start FROM appointments WHERE status = 'Scheduled' AND assigned_doctor = '$assigned_doctor' ";
        $query_run = mysqli_query($conn, $query);
        $events = array();
        ...
        <script>
            $(document).ready(function () {
                $(document).on('click', '.editdatebtn', function () {
                    ...
                    // Fill modal inputs with data
                    $('#updatedate_id').val(data[0]);    // Assuming first column is ID
                });
            });
        </script>
        <script>
