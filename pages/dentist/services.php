...
<head>
    ...
    <title>Services - Trinity Smiles Dental</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid px-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-primary font-weight-bold">Services</h1>
                ...
                <div class="modal fade" id="deletemodal" data-bs-backdrop="static" data-bs-keyboard="false"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="/dental-appointment-system/pages/dentist/api/deleteservice" method="post">
                ...
                <div class="modal fade" id="editmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="/dental-appointment-system/pages/dentist/api/updateservice" method="post">
                                <div class="modal-body">
                                    <input type="hidden" name="update_id" id="update_id">
                                    <div class="form-floating mb-3">
                                        <input id="updateService" type="text" name="service" maxlength="100"
                                            class="form-control form-control-md rounded-3" placeholder="Service"
                                            required onkeypress="return noNumber(event)"
                                            value="<?php echo $items['service'] ?>" />
                                        <label for="service">
                                            Service
                                        </label>
                                    ...
                                    <div class="form-floating mt-3">
                                        <textarea id="updateDescription" name="description"
                                            ...
                                            onkeypress="return noNumber(event)" placeholder="Description"
                                            style="height: 100px;" value="<?php echo $items['description'] ?>"></textarea>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-floating mt-3">
                                        <input id="updatePrice" type="text" name="price" maxlength="100"
                                            class="form-control form-control-md rounded-3" placeholder="Price"
                                            required onkeypress="return noLetter(event)"
                ...
                <div class="modal fade" id="addServiceModal" tabindex="-1" aria-labelledby="addServiceModal"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="/dental-appointment-system/pages/dentist/api/addservice" method="POST"
                                class="needs-validation" novalidate>
                                <div class="modal-body">
                                    <div class="form-floating">
                                        <input id="service" type="text" name="service" maxlength="100"
                                            class="form-control form-control-md rounded-3" required
                                            onkeypress="return noNumber(event)" placeholder="Service" />
                                        <div class="invalid-feedback">
                                            Please enter the service.
                                        </div>
                                    ...
                                    <div class="form-floating mt-3">
                                        <input id="price" type="text" name="price" maxlength="100"
                                            class="form-control form-control-md rounded-3" required
                                            onkeypress="return noLetter(event)" placeholder="Price" />
                                        <div class="invalid-feedback">
                                            Please enter the price.
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-book">Add Service</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function () {
                $(document).on('click', '.editbtn', function () {
                    ...
                    $('#updatePrice').val(data[3]);    // Assuming first column is ID
